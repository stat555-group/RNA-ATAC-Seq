...
cmp_vs_eth <- ErythroMinusCMP_results

# we want the log2 fold change 
original_gene_list <- cmp_vs_eth$log2FoldChange

# name the vector
names(original_gene_list) <- cmp_vs_eth$geneId
...
#cmp_vs_eth <- sort(as.data.frame(as.GRanges(anno_ErythroMinusCMP)[as.GRanges(anno_ErythroMinusCMP)$log2FoldChange > 0])$geneId, decreasing = TRUE)

#gse <- gseGO(cmp_vs_eth, OrgDb = "org.Mm.eg.db", ont = "BP", maxGSSize = 500, keyType  = "ENTREZID")
